...
;;;***

;;;### (autoloads nil "mew-w3m" "mew-w3m.el" (0 0 0 0))
;;; Generated autoloads from mew-w3m.el

(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "mew-w3m" '("mew-" "w3m-mail-compose-with-mew")))
...
;;;***

;;;### (autoloads nil "octet" "octet.el" (0 0 0 0))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "w3mhack" '("shimbun-module-directory" "w3mhack-")))
