...
Insert thumbnails before file names of marked files in the Dired buffer." t nil)
...
Add comment to this image file." t nil)

(autoload 'diredp-image-dired-tag-file "dired+" "\
Tag this image file with an `image-dired' tag." t nil)

(autoload 'diredp-image-dired-delete-tag "dired+" "\
Remove an `image-dired' tag from  this image file." t nil)
...
Uses `image-dired-get-exif-file-name' to name the new file." t nil)

(autoload 'diredp-image-dired-edit-comment-and-tags "dired+" "\
Edit comment and tags for this image file." t nil)
...
In Dired, add this file to the list of recently used files." t nil)

(autoload 'diredp-remove-this-from-recentf "dired+" "\
In Dired, remove this file from the list of recently used files." t nil)
...
The full text of the line is used as the file name." t nil)
...
Mark all autofiles, that is, files that have an autofile bookmark." t nil)

(autoload 'diredp-unmark-autofiles "dired+" "\
Unmark all autofiles, that is, files that have an autofile bookmark." t nil)
...
Omit lines of marked files.  Return the number of lines omitted." t nil)

(autoload 'diredp-omit-unmarked "dired+" "\
Omit lines of unmarked files.  Return the number of lines omitted." t nil)
...
Makes the first char of the name uppercase and the others lowercase." t nil)

(autoload 'diredp-downcase-this-file "dired+" "\
In Dired, rename this file to lower case." t nil)

(autoload 'diredp-upcase-this-file "dired+" "\
In Dired, rename this file to upper case." t nil)

(autoload 'diredp-rename-this-file "dired+" "\
In Dired, rename this file." t nil)

(autoload 'diredp-copy-this-file "dired+" "\
In Dired, copy this file." t nil)

(autoload 'diredp-relsymlink-this-file "dired+" "\
In Dired, make a relative symbolic link to file on cursor line." t nil)

(autoload 'diredp-symlink-this-file "dired+" "\
In Dired, make a symbolic link to this file." t nil)

(autoload 'diredp-hardlink-this-file "dired+" "\
In Dired, add a name (hard link) to this file." t nil)

(autoload 'diredp-print-this-file "dired+" "\
In Dired, print this file." t nil)

(autoload 'diredp-grep-this-file "dired+" "\
In Dired, grep this file." t nil)

(autoload 'diredp-compress-this-file "dired+" "\
In Dired, compress or uncompress this file." t nil)
...
In Dired, byte compile the (Lisp source) file on the cursor line." t nil)

(autoload 'diredp-load-this-file "dired+" "\
In Dired, load this file." t nil)

(autoload 'diredp-chmod-this-file "dired+" "\
In Dired, change the mode of this file." t nil)
...
Flag all of the files in the current region (if it is active) for deletion." t nil)
...
In Dired, visit this file or directory in another frame." t nil)
...
Describe Dired+." t nil)

(autoload 'diredp-send-bug-report "dired+" "\
Send a bug report about a Dired+ problem." t nil)
...
windows there, then delete its window (toggle : show/hide the file)." t nil)
